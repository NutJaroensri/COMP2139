...
namespace GBC_TRAVEL_GROUP_88.Controllers
{
    public class HomeController : Controller
    {
		...
		public IActionResult GeneralSearch(string searchType, string searchString)
		{
            ...
            else if (searchType == "HotelBookings")
            {

                return RedirectToAction("Search", "HotelBookings", new { area = "BookingManagement", searchString });
            }
            else if (searchType == "RentalCars")
            {

                return RedirectToAction("Search", "RentalCars", new { area = "BookingManagement", searchString });
            }
            else if (searchType == "RentalCarBookings")
            {

                return RedirectToAction("Search", "RentalCarBookings", new { area = "BookingManagement", searchString });
            }
